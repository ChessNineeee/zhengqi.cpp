...
template <int SIZE> void zhengqi::utility::FixedBuffer<SIZE>::cookieStart() {}

template <int SIZE> void zhengqi::utility::FixedBuffer<SIZE>::cookieEnd() {}
...
template <typename T> void zhengqi::utility::LogStream::formatInteger(T v) {
...
zhengqi::utility::LogStream &
zhengqi::utility::LogStream::operator<<(unsigned short v) {
...
zhengqi::utility::LogStream &
zhengqi::utility::LogStream::operator<<(unsigned int v) {
  formatInteger(v);
  return *this;
}
...
zhengqi::utility::LogStream &
zhengqi::utility::LogStream::operator<<(unsigned long v) {
  formatInteger(v);
  return *this;
}

zhengqi::utility::LogStream &
zhengqi::utility::LogStream::operator<<(long long v) {
  formatInteger(v);
  return *this;
}

zhengqi::utility::LogStream &
zhengqi::utility::LogStream::operator<<(unsigned long long v) {
  formatInteger(v);
  return *this;
}

zhengqi::utility::LogStream &
zhengqi::utility::LogStream::operator<<(const void *p) {
...
template <typename T> zhengqi::utility::Fmt::Fmt(const char *fmt, T val) {
